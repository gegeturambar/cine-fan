(function() {
    ...
    function rating(el, currentRating, maxRating, callback ) {
         ...
         * detachEvents
         *
         * @description A simple function used to detach Events from the stars
         *   Returns nothing.
         */
        function detachEvents() {
            for (var i = 0; i < stars.length; i++) {
                console.log("detach for star "+i);
                detachStarEvents(stars[i]);
            }
        }
         ...
         * detachStarEvents
         *
         * @description Detaches events to each star in the collection. Returns
         *   nothing.
         * @param {HTMLElement} star The star element
         */
         ...
         * detachStarMouseOver
         *
         * @description Detach the mouseover event for the star. Returns nothing.
         * @param {HTMLElement} star The star element
         */
        ...
        function mouseOverListener(e){
            let star = e.target || e.srcElement;
         ...
         * detachStarMouseOut
         *
         * @description Detach the mouseout event for the star. Returns nothing.
         * @param {HTMLElement} star The star element
         */
         ...
         * detachStarClick
         *
         * @description Detach the click event for the star. Returns nothing.
         * @param {HTMLElement} star The star element
         */
